...
$config['mongo_db']['detailDatabase']['no_auth'] = FALSE;
$config['mongo_db']['detailDatabase']['hostname'] = 'localhost';
$config['mongo_db']['detailDatabase']['port'] = '27017';
$config['mongo_db']['detailDatabase']['username'] = 'root';
$config['mongo_db']['detailDatabase']['password'] = '';
$config['mongo_db']['detailDatabase']['database'] = 'detaildb';
$config['mongo_db']['detailDatabase']['db_debug'] = TRUE;
$config['mongo_db']['detailDatabase']['return_as'] = 'array';
$config['mongo_db']['detailDatabase']['write_concerns'] = (int)1;
$config['mongo_db']['detailDatabase']['journal'] = TRUE;
$config['mongo_db']['detailDatabase']['read_preference'] = NULL;
$config['mongo_db']['detailDatabase']['read_preference_tags'] = NULL;

// $config['mongo_db']['test']['no_auth'] = FALSE;
// $config['mongo_db']['test']['hostname'] = 'localhost2';
